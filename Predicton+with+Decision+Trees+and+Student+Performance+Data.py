...
import numpy as np
print("Passing: %d out of %d (%0.2f%%)" % (np.sum(d_pass),len(d_pass), 100*float(np.sum(d_pass)) / len(d_pass)))
...
# show average score and +/- two standard deviatons away (covering 95% of scores)
